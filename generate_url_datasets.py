...
# ---------------------------加载训练的词向量-----------------------------
word_vec_dict = dict()
with open(file="./vec_dict/cbow_nge_url_vec.txt", mode='r', encoding='utf-8') as f1:
    lines = f1.readlines()
    for line in lines:
...
all_url_vec_type0 = []
with open(file="./neg_url_tokens/domain_exist_at_nec_tokens.txt", mode='r', encoding='utf-8') as f:
...
all_url_vec_type1 = []
with open(file="./neg_url_tokens/domain_is_ip_tokens.txt", mode='r', encoding='utf-8') as f:
    lines = f.readlines()
    for line in lines:
        words_list = line.split()
        single_url_vec = []
...
all_url_vec_type2 = []
with open(file="./neg_url_tokens/real_domain_exist_at_nec_and_others_tokens.txt", mode='r', encoding='utf-8') as f:
    lines = f.readlines()
    for line in lines:
        words_list = line.split()
        single_url_vec = []
...
all_url_vec_type3 = []
with open(file="./neg_url_tokens/real_domain_exist_at_others_tokens.txt", mode='r', encoding='utf-8') as f:
    lines = f.readlines()
    for line in lines:
        words_list = line.split()
        single_url_vec = []
...
all_url_vec_type4 = []
with open(file="./neg_url_tokens/url_no_obvious_domain_tokens.txt", mode='r', encoding='utf-8') as f:
    lines = f.readlines()
    for line in lines:
        words_list = line.split()
        single_url_vec = []
...
all_url_vec_type5 = []
with open(file="./pos_url_tokens/pos_url_tokens.txt", mode='r', encoding='utf-8') as f:
    lines = f.readlines()
    for line in lines:
        words_list = line.split()
        single_url_vec = []
